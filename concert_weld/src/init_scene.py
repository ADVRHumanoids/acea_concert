class InitScene:
    ...
    def launch_scene(self):
        ...
        # Pipe marker
        subprocess.Popen([
            "python3", str(self.path_ws / "src" / "concert_weld" / "src" / "rviz_pipe_marker.py"),
            'weld_pipe',
        ...
        # Footprint marker
        subprocess.Popen([
            "python3", str(self.path_ws / "src" / "concert_weld" / "src" / "rviz_rectangle_marker.py"),
            'footprint_robot',
            str(0.0), str(0.0),
        ...
        subprocess.Popen([
            "python3", str(self.path_ws / "src" / "concert_weld" / "src" / "rviz_line_marker.py"),
            'weld_trajectory',
